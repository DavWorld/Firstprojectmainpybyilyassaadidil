...
requirements = python3,kivy==2.2.1,pillow,Flask,google-api-core,google-api-python-client,google-auth,google-auth-httplib2,googleapis-common-protos,PyAudio,pydub
